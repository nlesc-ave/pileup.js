...
'../LocalStringFile');var _LocalStringFile2 = _interopRequireDefault(_LocalStringFile);var _dataVcf = require(
'../data/vcf');var _dataVcf2 = _interopRequireDefault(_dataVcf);
...
function create(data) {var 
  ...
  if (url) {
    return createFromVcfFile(new _dataVcf2['default'](new _RemoteFile2['default'](url)));} else 
  if (content) {
    return createFromVcfFile(new _dataVcf2['default'](new _LocalStringFile2['default'](content)));}
